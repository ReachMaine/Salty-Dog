...
<div class="grid-container">
	...
	<div id="primary" class="grid-<?php echo ($post_type == 'portfolio'|| $layout =='full_width' ) ? '100' : '100'; ?> <?php echo $layout ? $layout : null; ?> tablet-grid-100 mobile-grid-100" role="main">
